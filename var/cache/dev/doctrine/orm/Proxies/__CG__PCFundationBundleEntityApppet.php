 ...
 */
class Apppet extends \PC\FundationBundle\Entity\Apppet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'appuser', 'reports', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'id', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'name', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'age', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'species', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'race', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'colour', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'gender', '' . "\0" . 'PC\\FundationBundle\\Entity\\Apppet' . "\0" . 'status'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Apppet $proxy) {
    ...
    public function setAppuser(\PC\FundationBundle\Entity\Appuser $appuser = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAppuser', [$appuser]);
    ...
    public function getAppuser()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAppuser', []);
    ...
    public function removeReport(\PC\FundationBundle\Entity\Report $report)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReport', [$report]);

        return parent::removeReport($report);
    }
